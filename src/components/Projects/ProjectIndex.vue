    ...
    <div v-else>
      ...
      >
        <div
          ...
          :key="index"
          class="relative bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 cursor-pointer group"
        >
          <router-link
            :to="{
              name: 'ProjectDetail',
